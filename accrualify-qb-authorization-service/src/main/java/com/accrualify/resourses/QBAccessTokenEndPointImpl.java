...
public class QBAccessTokenEndPointImpl implements AccessTokenEndPoint {
    private static final transient Log log = LogFactory.getLog(QBAccessTokenEndPointImpl.class);
    ...
    public static Map<String,String> getRefreshAccessToken(String accessToken, String refreshToken,String consumerKey, String consumerSecKey, String tokenValidity) throws OAuthException{
        ...
        if (tokenValidity.equals("true")) {
            ...
            synchronized (QBAccessTokenEndPointImpl.class) {
                if (!tokenCreateFlag){
                    try {
